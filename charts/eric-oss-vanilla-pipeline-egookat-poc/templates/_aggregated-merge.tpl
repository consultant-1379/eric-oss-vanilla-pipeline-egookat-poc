...
*/ -}}
{{- define "eric-oss-vanilla-pipeline-egookat-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-vanilla-pipeline-egookat-poc.mergeAnnotations" -}}
  {{- include "eric-oss-vanilla-pipeline-egookat-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-vanilla-pipeline-egookat-poc.mergeLabels" -}}
  {{- include "eric-oss-vanilla-pipeline-egookat-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
